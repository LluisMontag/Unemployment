...
*Mark RETIRED 
gen RetiredW1=1 if WORK2C==5 | WORK2C11==1 | WORK2C12==1
gen RetiredW2=1 if WORK2C11_W2==1 | WORK2C12_W2==1
gen RetiredW3=1 if WORK2C11_W3==1 | WORK2C12_W3==1
gen RetiredW4=1 if WORK2C11_W4==1 | WORK2C12_W4==1

**Mark HOMEMAKERS
gen HomemakerW1=1 if WORK_2C==6 | WORK2C==9| WORK2C9==1
gen HomemakerW2=1 if WORK2C9_W2==1 
gen HomemakerW3=1 if WORK2C9_W3==1
gen HomemakerW4=1 if WORK2C9_W4==1

**Mark STUDENTS 
gen StudentW1=1 if WORK_2C==7 | WORK2C==10| WORK2C10==1
gen StudentsW2=1 if WORK2C10_W2==1
gen StudentsW3=1 if WORK2C10_W3==1
gen StudentsW4=1 if WORK2C10_W4==1


**Mark UNFIT
gen UnfitW1=1 if WORK_2C==4 | WORK2C==7| WORK2C7==1
gen UnfitW2=1 if WORK2C7_W2==1
gen UnfitW3=1 if WORK2C7_W3==1
gen UnfitW4=1 if WORK2C7_W4==1

foreach var of varlist Retired* Homemaker* Students* Unfit* {
...
gen PartnerW2=1 if DEMO7C_W2<4
replace PartnerW2=. if DEMO7C_W2==.
gen PartnerW3=1 if DEMO7C_W3<4
replace PartnerW3=. if DEMO7C_W3==.
gen PartnerW4=1 if DEMO7_W4<4
replace PartnerW4=. if DEMO7_W4==.
...
save "G:\OV20_0544\EXPORT\DATASETS\Cleaning_WIDE_nodrop240621.dta", replace
...
rename W37 W3
rename W410 W4
rename PartnerW37 PartnerW3
rename PartnerW410 PartnerW4
...
rename *W37 *W3
rename *W410 *W4
drop *W21 *W31 *W41 *W22 *W32 *W42 *W36 *W46 *W27 *W47 *W210 *W310 *W211 *W311 
rename HED2W411 HED2W4
...
**Employment Status including inactive individuals
gen Work5W2_cat = Unemp2W2_cat
replace Work5W2_cat=3 if StudentsW2==1
replace Work5W2_cat=4 if UnfitW2==1
replace Work5W2_cat=5 if RetiredW2==1
replace Work5W2_cat=6 if HomemakerW2==1
label def Work5W2_cat 0"Employed" 1"Short Unemployment" 2"Long Unemployment" 3"Student" 4"Unfit" 5"Retired" 6"Homemaker", modify
label val Work5W2_cat Work5W2_cat

gen Work5W3_cat = Unemp2W3_cat
replace Work5W3_cat=3 if StudentsW3==1
replace Work5W3_cat=4 if UnfitW3==1
replace Work5W3_cat=5 if RetiredW3==1
replace Work5W3_cat=6 if HomemakerW3==1
label def Work5W3_cat 0"Employed" 1"Short Unemployment" 2"Long Unemployment" 3"Student" 4"Unfit" 5"Retired" 6"Homemaker", modify
label val Work5W3_cat Work5W3_cat

gen Work5W4_cat = Unemp2W4_cat
replace Work5W4_cat=3 if StudentsW4==1
replace Work5W4_cat=4 if UnfitW4==1
replace Work5W4_cat=5 if RetiredW4==1
replace Work5W4_cat=6 if HomemakerW4==1
label def Work5W4_cat 0"Employed" 1"Short Unemployment" 2"Long Unemployment" 3"Student" 4"Unfit" 5"Retired" 6"Homemaker", modify
label val Work5W4_cat Work5W4_cat
...
*Merge Educational Attainment (includes codification of open answers)*
...
gen PartnerW1 = Marital_W1
replace PartnerW1 = PartnerW3 if PartnerW1==.
replace PartnerW1 = PartnerW4 if PartnerW1==.


save "G:\OV20_0544\EXPORT\DATASETS\Clean_wide_include_inactive_050621.dta", replace
...
save "G:\OV20_0544\EXPORT\DATASETS\Clean_wide_CCA_include_inactive_050621.dta"
